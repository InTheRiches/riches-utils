...
public class ItemUtilities {
     ...
     * @return The modified ItemStack
     */
    public static ItemStack setDyeColor(ItemStack item, Color color) {
     ...
     * @return The modified ItemStack
     */
    public static ItemStack setSkullOwningPlayer(ItemStack item, OfflinePlayer player) {
        SkullMeta profileMeta = (SkullMeta) item.getItemMeta();
        profileMeta.setOwningPlayer(player.getPlayer());
        item.setItemMeta(profileMeta);
        return item;
    }
    ...
    private static Object serialize(Object o) {
        if (o instanceof ConfigurationSerializable) {
            ...
            list.stream().map(ItemUtilities::serialize).forEach(json::add);
            return json;
        }
        return o;
    }
