...
public enum Translations {
    ...
    MARKET_PURCHASE_ONE(ChatColor.YELLOW + "Click and drag to your"),
    MARKET_PURCHASE_TWO(ChatColor.YELLOW + "cart to buy this item!"),
    ...
    CLOSE_INVENTORY_LORE(ChatColor.YELLOW + "Click to close this menu."),
    ...
    EMOJIS_ALREADY_ENABLED(ChatColor.RED + "Emojis are already enabled!"),
    EMOJIS_ALREADY_DISABLED(ChatColor.RED + "Emojis are already disabled!"),
    EMOJIS_ENABLED(ChatColor.GOLD + "Successfully " + ChatColor.GREEN + "enabled" + ChatColor.GOLD + " emojis!"),
    EMOJIS_DISABLED(ChatColor.GOLD + "Successfully " + ChatColor.RED + "disabled" + ChatColor.GOLD + " emojis!"),
